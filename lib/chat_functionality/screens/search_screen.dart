    ...
    final List<User> suggestionList = query.isEmpty
        ...
        : userList != null
            ? userList.where((User user) {
                String _getdisplayName = user.displayName.toLowerCase();
                String _query = query.toLowerCase();
                String _getName = user.name.toLowerCase();
                bool matchesdisplayName = _getdisplayName.contains(_query);
                bool matchesName = _getName.contains(_query);

                return (matchesdisplayName || matchesName);

                // (User user) => (user.displayName.toLowerCase().contains(query.toLowerCase()) ||
